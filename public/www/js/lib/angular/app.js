...
define([
  ...
  './controllers/index', './services/index', 'ufi.core', 'ufi.schema', 'ufi.frameGen'
  /* ,'./directives/index'
     ,'./filters/index'
     
   */

], function (controllers, services, uficore, ufischema ,ufiframegen) {
  'use strict';
  var context={};
  ...
  webApp.provider('heaerieUssService', function heaerieUssServiceProvider() {
    ...
    this.GenHtmlTemplateFromSJson = function (jsonSchema, value, mode) {
      ...
      if (context) {
        context=ufischema.exportSchemaContext(
          eval('[{"htmlType"	:  "INPUT","dataType"	:  "namespace","cclass"	:  "cclass","min"		:  0 ,"max"		:  "unlimited","listVal"	:  "","helpLink"	:  "","name" 	: "heaerie", "childs" : [{"htmlType"	:  "INPUT","dataType"	:  "package","cclass"	:  "cclass","min"		:  0 ,"max"		:  "unlimited","listVal"	:  "","helpLink"	:  "","name"          :  "system","childs"  : [{"name"		:  "NUMBER","htmlType"	:  "INPUT","dataType"	:  "primitive","cclass"	:  "cclass","min"		:  0 ,"max"		:  10 ,"listVal"	:  "","helpLink"	:  "","validate"     : "/^\\d{1,2}\\/\\d{1,2}\\/\\d{4}$/"} , {"name"		:  "TIME","htmlType"	:  "INPUT","dataType"	:  "primitive","cclass"	:  "cclass","min"		:  0 ,"max"		:  1 ,"listVal"	:  "","helpLink"	:  "","validate" 	: "/^\\d{1,2}:\\d{2}([ap]m)?$/"} , {"name"		:  "DATE","htmlType"	:  "INPUT","dataType"	:  "primitive","cclass"	:  "cclass","min"		:  0 ,"max"		:  1 ,"listVal"	:  "","helpLink"	:  "","validate" : "/^\\d{1,2}\\/\\d{1,2}\\/\\d{4}$/"} , {"name"		:  "CHAR","htmlType"	:  "INPUT","dataType"	:  "primitive","cclass"	:  "cclass","min"		:  0 ,"max"		:  1 ,"listVal"	:  "","helpLink"	:  "","validate" : "/^[A-Za-z0-9_]$/"} , {"name"		:  "VARCHAR","htmlType"	:  "INPUT","dataType"	:  "primitive","cclass"	:  "cclass","min"		:  0 ,"max"		:  1 ,"listVal"	:  "","helpLink"	:  "","validate" : "/^[A-Za-z0-9_]$/"} ] } ] } ]')
          , context);
      }
      context=ufischema.exportSchemaContext(schemaJson, context);
      ...
      var func = value;
      var ussScript = us.frameGeneration(usListVal[schemaJson[0].name], usResource[schemaJson[0].name], OutJson[schemaJson[0].name], schemaJson[0].childs, schemaJson[0], 0, func, 0, mode);
  ...
  */
  webApp.config(['$routeProvider', '$locationProvider', '$httpProvider', '$stateProvider', '$urlRouterProvider', 'heaerieUssServiceProvider', '$injector', function ($routeProvider, $locationProvider, $httpProvider, $stateProvider, $urlRouterProvider, heaerieUssServiceProvider, $injector) {
    // body...
