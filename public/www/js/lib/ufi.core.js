define(function (require, exports, module) {
  ...
  USS.prototype.AddSubling = function (fieldObj, parentid) {
    ...
    //DataCategory
    var divCurrDivDataCategory = document.createElement("select");
    ...
    var inpStrArr = "PRIMITIVE|primitive|DERIVED|Derived|COMPLEX|Complex".split('|');
    var divCurrDivDataCategoryOption = "";
    //alert(fieldObj.htmlType );
    for (var i = 0; i < inpStrArr.length; i += 2) {
      divCurrDivDataCategoryOption = document.createElement("option");
      divCurrDivDataCategoryOption.value = inpStrArr[i];
      divCurrDivDataCategoryOption.appendChild(document.createTextNode(inpStrArr[i + 1]));
      divCurrDivDataCategoryOption.id = "option";
      if (inpStrArr[i] == fieldObj.htmlType) {
        divCurrDivDataCategoryOption.setAttribute('selected', 'true');
      }
      divCurrDivDataCategory.appendChild(divCurrDivDataCategoryOption);
    }
