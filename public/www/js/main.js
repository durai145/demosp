...
require.config({
    ...
    shim: {
        ...
        'app': {
            'deps': ['angular', 'jquery', 'angularRoute', 'ngResource', 'angularUiRouter', 'angularAnimate', 'excanvas', 'jqueryFlot', 'jqueryFlotPie', 'toaster', 'ufi', 'ufi.frameGen', 'ufi.validate', 'ufi.xml', 'ufi.schema']
        }
